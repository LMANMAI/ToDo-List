  ...
  switch (action.type) {
    ...
    case OBTENER_PROYECTOS:
      return {
        ...
        proyectos: action.payload.filter((proyecto: any) =>
          proyecto.estado ? null : action.payload
        ),
        proyectosterminados: action.payload.filter((proyecto: any) =>
          proyecto.estado ? action.payload : null
        ),
        mensaje: null,
      };
    ...
    case PROYECTO_ACTIVO:
      return {
        ...
        proyectoactivo: state.proyectos.filter(
          (proyecto: any) => proyecto._id === action.payload._id
        ),
        panel: false,
        panelproyecto: false,
      };
    ...
    case ELIMINAR_PROYECTO:
      return {
        ...state,
        proyectos: state.proyectos.filter(
          (proyecto: any) => proyecto._id !== action.payload
        ),
        proyectosterminados: state.proyectosterminados.filter(
          (proyecto: any) => proyecto._id !== action.payload
        ),
        proyectoactivo: null,
        mensaje: null,
